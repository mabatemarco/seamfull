...
class CuisinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuisine" do
    assert_difference('Cuisine.count') do
      post cuisines_url, params: { cuisine: { restaurant_id: @cuisine.restaurant_id } }, as: :json
    end
  ...
  test "should update cuisine" do
    patch cuisine_url(@cuisine), params: { cuisine: { restaurant_id: @cuisine.restaurant_id } }, as: :json
    assert_response 200
  end
